...
class MiniImagenet(Dataset):
    ...
    def __init__(self, root, mode, resize=28, startidx=0, memorize=False, elem_per_class=600, test=False, classes=list(range(400)), seed=10):
        """
        ...
        self.elem_per_class = 600

        chosen = elem_per_class
